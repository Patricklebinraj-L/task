...
router.get("/:id", check, authorize, controller.getBook)

router.put("/:id", check, authorize, controller.updateBook)
router.delete("/:id", check, authorize, controller.deleteBook)
